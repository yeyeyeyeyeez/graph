...
* @fileName About.vue
* @author weixueyuan
* @date 2020/07/08 19:59:26
!-->
<template>
  <div>
    <div id="main" style="width:100%;height:800px"></div>
    <el-button @click="changecircle()">环形布局</el-button>
    <el-button @click="changeforce()">力布局</el-button>
  </div>
</template>
        ...
        series: [
          {
            ...
            layout: this.layout, //图的布局，类型为环形导图
            focusNodeAdjacency: true, //是否在鼠标移到节点上的时候突出显示节点以及节点的边和邻接节点。
            symbol: ["circle"], //节点图形圆形。
            symbolRotate: 360, //关系图节点标记的旋转角度（而非弧度）。
            edgeSymbol: ["circle", "arrow"], //边两 ·端的标记类型
